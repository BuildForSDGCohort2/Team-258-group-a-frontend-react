                        ...
                        <div className="left-part">
                            <div className="logo-area">
                                <div className="row">
                                    <div className="col-lg-8">
                                        <img className="img-fluid ml-2 mt-1 float-left text-left align-top"
                                            src="img/logo/300x80.png" alt="Fumana logo" />
                                    </div>
                                ...
                                <div className="place-holder-img justify-content-center align-content-center text-center">
                                    <img className="img-fluid" src="img/logo/300x400.png" alt="Fumana" />
                            </div>
                                </div>
                            </div>
                            {/* right part STARTS */}
                                        ...
                                        <div className="col-12 col-md-7">
                                            <div className="sign-up-area float-right mx-5 mx-md-3">
                                                To join Fumana? &nbsp;<a
                                                    ...
                                                    title="Sign up" href="signup.html">Sign Up here</a>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="row">
                                            ...
                                            */}
                                            <button onClick={clickSubmit} type="submit"
                                                ...
                                                <div className="login-trouble my-4">
                                                    <a href="forgot-pass.html" className="text-decoration-none color-primary"
                                                ...
                                                <div className="auth-ending mt-2">
                                                    ...
                                                    us</a>
                                                        ...
                                                        <span>
                                                            <a className="color-primary text-decoration-none ml-2"
                                                                title="Privacy policy" href="privacy.html">Privacy
                                                    policy</a>
                                                        </span>
                                                    </div>
